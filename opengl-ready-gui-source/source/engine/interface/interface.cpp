...
void Interface::create() {
	...
	text1.create_static("Simple text 0123", "tahoma_6", 50, 50, "left", "normal", glm::vec4(255.f));
	text2 = gui::SimpleText("static");
	text2.create_static("Simple text 0123", "tahoma_8", 200, 300, "left", "normal", glm::vec4(255.f, 0.f, 0.f, 255.f));
	text3 = gui::SimpleText("static");
	text3.create_static("Simple text 0123", "inconsolata_8", 50, 500, "left", "normal", glm::vec4(0.f, 255.f, 0.f, 255.f));
	rect1 = gui::Rectangle();
